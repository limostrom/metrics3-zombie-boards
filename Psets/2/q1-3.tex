...
\FunctionTok{setwd}\NormalTok{(}\StringTok{"C:/Users/17036/OneDrive/Documents/GitHub/metrics3{-}zombie{-}boards/Psets/2/PS2Data"}\NormalTok{)}
\NormalTok{BWGHT }\OtherTok{\textless{}{-}} \FunctionTok{read.delim}\NormalTok{(}\StringTok{"BWGHT\_RAW.txt"}\NormalTok{, }\AttributeTok{header=}\ConstantTok{FALSE}\NormalTok{)}
